"""
Django settings for django_my_website project.
...
ALLOWED_HOSTS = ["saugau.com", "localhost", "127.0.0.1", "104.198.17.87"]
...
ROOT_URLCONF = 'django_my_website.urls'
...
WSGI_APPLICATION = 'django_my_website.wsgi.application'
